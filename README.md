...
- [ShellWard by jnMetaCode](https://github.com/jnMetaCode/shellward) - AI agent security middleware with 8-layer defense — prompt injection detection (32 rules), DLP-style data flow tracking, dangerous command blocking, PII detection. Works as SDK or OpenClaw plugin. Zero dependencies.
